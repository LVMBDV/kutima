...
describe ButtonToComponent, type: :component do
  ...
  context 'with color specified' do
    subject(:render_component) do
      render_inline(described_class.new(link: 'foo/bar', options: { color: 'red' })) { 'Sample Text' }
    end
  ...
  context 'with outline specified' do
    subject(:render_component) do
      render_inline(described_class.new(link: 'foo/bar', options: { outline: true })) { 'Sample Text' }
    end
  ...
  context 'with both color and outline specified' do
    subject(:render_component) do
      render_inline(described_class.new(link: 'foo/bar', options: { color: 'red', outline: true })) { 'Sample Text' }
    end
